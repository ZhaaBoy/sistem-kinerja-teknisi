            ...
            <div class="absolute">
                <svg width="612" height="697" viewBox="0 0 612 697" fill="none"
                    ...
                    <path
                        ...
                        stroke="var(--color-primary)" stroke-opacity="0.3" stroke-dasharray="8 8" />
                    <path
                        ...
                        fill="url(#paint0_linear_13715_136336)" fill-opacity="0.08" />
                    <path
                        ...
                        stroke="var(--color-primary)" stroke-opacity="0.2" />
                    <defs>
                        <linearGradient id="paint0_linear_13715_136336" x1="500.914" y1="92.9818" x2="110.036"
                            y2="606.206" gradientUnits="userSpaceOnUse">
            ...
            <div
                ...
                {{-- <div class="flex items-center gap-3">
                    <a href="#" class="flex items-center gap-3">
                        <h1 class="items-center text-xl font-bold">Logo</h1>
                    </a>
                </div> --}}
                <div>
                ...
                <div class="space-y-4">
                    ...
                    <p class="text-base-content/80 mb-4 text-center">
                        New on our platform?
                        <a href="auth-register-1.html" class="link link-animated link-primary font-normal">Create an
                            account</a>
                    </p>
                    {{-- <div class="divider">or</div>
                    <button class="btn btn-text btn-block">
                        <img src="{{ asset('template/assets/img/icons/brands/google.png') }}" alt="google icon"
